...
// Stream para estar pendiente de los cambios de favoritos
// final isMovieFavoriteStream = StreamProvider((ref) {
    ...
    return SliverAppBar(
      ...
      actions: [
        ...
        icon: isFavoriteFuture.when(
          ...
          error: (err, stack) => throw UnimplementedError(), 
